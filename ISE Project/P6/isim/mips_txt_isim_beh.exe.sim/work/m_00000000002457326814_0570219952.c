...
#endif
static const char *ng0 = "C:/Users/Hihiczx/Documents/ISE Project/P6/ControlUnit_M.v";
...
LAB219:    t740 = ((char*)((ng3)));
    goto LAB220;

LAB221:    xsi_vlog_unsigned_bit_combine(t621, 2, t735, 2, t740, 2);
    goto LAB225;
...
LAB202:    t681 = (t372 + 4);
    t682 = *((unsigned int *)t372);
    t683 = *((unsigned int *)t681);
    t684 = (t682 || t683);
    if (t684 > 0)
        goto LAB203;

LAB204:    t686 = *((unsigned int *)t372);
    t687 = (~(t686));
...
LAB208:    if (*((unsigned int *)t372) > 0)
        goto LAB209;

LAB210:    memcpy(t371, t690, 8);
...
LAB203:    t685 = ((char*)((ng2)));
    goto LAB204;

LAB205:    t692 = (t0 + 5208U);
    t693 = *((char **)t692);
    memset(t691, 0, 8);
    t692 = (t693 + 4);
...
LAB207:    xsi_vlog_unsigned_bit_combine(t371, 2, t685, 2, t690, 2);
    goto LAB211;

LAB209:    memcpy(t371, t685, 8);
    goto LAB211;
...
LAB216:    t704 = ((char*)((ng4)));
    goto LAB217;

LAB218:    t709 = ((char*)((ng3)));
    goto LAB219;

LAB220:    xsi_vlog_unsigned_bit_combine(t690, 2, t704, 2, t709, 2);
    goto LAB224;
...
extern void work_m_00000000002457326814_0570219952_init()
{
	static char *pe[] = {(void *)Cont_81_0,(void *)Cont_85_1,(void *)Cont_90_2,(void *)Cont_95_3,(void *)Cont_100_4};
	xsi_register_didat("work_m_00000000002457326814_0570219952", "isim/mips_txt_isim_beh.exe.sim/work/m_00000000002457326814_0570219952.didat");
